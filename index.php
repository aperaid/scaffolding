    ...
    <tbody>
      ...
      <tr>
        <th>&nbsp;</th>
				...
				<tr>
					<td>
                    	<a href="Penjualan/Customer/Customer.php"><button class="button" type=
                        "button">Customer</button></a>
                    </td>
				</tr>
				<tr>
					<td>
                    	<a href="Penjualan/Project/Project.php"><button class="button" type=
                    	"button">Project</button></a>
                    </td>
				</tr>
				<tr>
					<td>
						<a href="Penjualan/POCustomer/POCustomer.php"><button class="button" type=
						"button">PO Customer</button></a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="Penjualan/TransaksiJual/TransaksiJual.php"><button class="button" type=
						"button">Transaksi Jual</button></a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="Penjualan/TransaksiSewa/TransaksiSewa.php"><button class="button" type=
				...
				<tr>
					<td>
						<a href="Penjualan/TransaksiClaim/TransaksiClaim.php"><button class="button"
						type="button">Transaksi Claim</button></a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="Penjualan/SewaJT/SewaJT.php"><button class="button" type="button">Sewa
