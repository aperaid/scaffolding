...
$query_View = sprintf("SELECT * FROM jualsuratjalan WHERE Id = %s", GetSQLValueString($colname_View, "int"));
  ...
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td colspan="2"><input name="No" type="text" class="textview" id="No" value="<?php echo $row_View['No']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <td colspan="2"><input name="NoCustomer" type="text" class="textview" id="NoCustomer" value="<?php echo $row_View['NoCustomer']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <td colspan="2"><input name="NoProject" type="text" class="textview" id="NoProject" value="<?php echo $row_View['NoProject']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <td colspan="2"><input name="SJPB" type="text" class="textview" id="SJPB" value="<?php echo $row_View['SJPB']; ?>" readonly></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="center">&nbsp;</td>
      ...
      <tr>
        <td align="center">&nbsp;</td>
        <td colspan="2" align="center"><a href="EditSuratJalan.php?Id=<?php echo $row_View['Id']; ?>">
          <button type="button" class="button2">Edit Surat Jalan</button></a></td>
        <td width="155"><a><button type="button" class="button2">Print</button></a></td>
        <td width="415"><a href="SuratJalan.php"><button type="button" class="button2">Cancel</button></a></td>
      </tr>
    </tbody>
  </table>
</form>
