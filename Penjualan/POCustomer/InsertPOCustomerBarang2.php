                ...
                <div class="box-body">
                  <table class="table table-hover table-bordered" id="customFields">
                    <thead>
                      ...
                      <th><a href="javascript:void(0);" class="addCF glyphicon glyphicon-plus"></a></th>
                    </thead>
                  </table>
                </div>
                <!-- /.box-body -->
