...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE jualpocustomer SET Reference=%s, Tgl=%s, Customer=%s, JS=%s, Project=%s, Amount=%s, Status=%s WHERE Id=%s",
...
mysql_select_db($database_Connection, $Connection);
$query_Edit = sprintf("SELECT * FROM jualpocustomer WHERE Id = %s", GetSQLValueString($colname_Edit, "int"));
  ...
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td width="557"><input name="Reference" type="text" id="Reference" autocomplete="off" value="<?php echo $row_Edit['Reference']; ?>" onKeyUp="capital()" class="textbox"></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Tgl</th>
        <th align="right">&nbsp;</th>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <td><input name="JS" type="text" id="JS" value="<?php echo $row_Edit['JS']; ?>" readonly class="textbox">
      ...
      <tr>
        ...
        <td><a href="ViewPOCustomer.php?Id=<?php echo $row_Edit['Id']; ?>"><button type="button" class="submit">Cancel</button></a></td>
      </tr>
    </tbody>
  </table>
