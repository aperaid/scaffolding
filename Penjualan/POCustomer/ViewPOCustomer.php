...
$query_View = sprintf("SELECT * FROM jualpocustomer WHERE Id = %s", GetSQLValueString($colname_View, "int"));
...
<table width="800" border="0">
  ...
  <tbody>
    <tr>
      <th align="center"><h2><?php echo $row_View['Reference']; ?></h2></th>
    </tr>
  </tbody>
</table>
</p>
<form id="form1" name="form1" method="POST">
  <table width="1000" border="0">
    <tbody>
      ...
      <tr>
        <td align="right"></td>
        <td colspan="2" align="center"><a href="EditPOCustomer.php?Id=<?php echo $row_View['Id']; ?>">
          <button type="button" class="button2">Edit PO Customer</button></a></td>
        <td width="155"><a><button type="button" class="button2">Print</button></a></td>
        <td width="415"><a href="POCustomer.php"><button type="button" class="button2">Back</button></a></td>
      </tr>
    </tbody>
  </table>
</form>
