...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jualpocustomer (Reference, Tgl, Customer, JS, Project, Amount, Status) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td width="557"><input name="Reference" type="text" id="Reference" autocomplete="off" onKeyUp="capital()" class="textbox"></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
