...
$query_View = sprintf("SELECT project.*, customer.Alamat, customer.Company, customer.CompPhone, customer.CCode FROM project INNER JOIN customer ON project.CCode=customer.CCode WHERE PCode = %s", GetSQLValueString($colname_View, "text"));
  ...
  <table width="1005" border="0">
    <tbody>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <th width="150" align="left"><input name="Company" type="text" class="textview" id="Company" value="<?php echo $row_View['Company']; ?>" readonly></th>
        <th width="100" align="right">Phone</th>
        <th width="50" align="right">&nbsp;</th>
        <td width="425"><input name="CompPhone" type="text" class="textview" id="CompPhone" value="<?php echo $row_View['CompPhone']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
