  ...
  <table width="1005" border="0">
    <tbody>
      <tr>
        ...
        <th colspan="2" align="left"><input name="PCode" type="text" class="textbox" id="PCode" style="width:514px;" autocomplete="off" onKeyUp="capital()" value="<?php echo $row_Edit['PCode']; ?>"></th>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Project</th>
        <th align="right">&nbsp;</th>
        <th colspan="2" align="left"><input name="Project" type="text" class="textbox" id="Project" style="width:514px;" autocomplete="off" onKeyUp="capital()" value="<?php echo $row_Edit['Project']; ?>"></th>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Customer Code</th>
        <th align="right">&nbsp;</th>
        <th colspan="2" align="left"><input name="CCode" type="text" class="textbox" id="CCode" style="width:514px;" autocomplete="off" onKeyUp="capital()" value="<?php echo $row_Edit['CCode']; ?>"></th>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="center">&nbsp;</td>
      ...
      <tr>
        ...
        <td align="center">&nbsp;</td>
        <td align="center"></td>
        <td width="202" align="left"><input type="submit" name="submit" id="submit" class="submit" value="Update"></td>
