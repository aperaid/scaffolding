...
$query_View = sprintf("SELECT * FROM jualsewajt WHERE Id = %s", GetSQLValueString($colname_View, "int"));
...
<form id="form1" name="form1" method="POST">
  <table width="1000" border="0">
    <tbody>
      ...
      <tr>
        <td align="center">&nbsp;</td>
        <td colspan="2" align="center"><a href="EditSewaJT.php?Id=<?php echo $row_View['Id']; ?>">
          <button type="button" class="button2">Edit Sewa JT</button></a></td>
        <td width="155"><a><button type="button" class="button2">Print</button></a></td>
        <td width="415"><a href="SewaJT.php"><button type="button" class="button2">Back</button></a></td>
      </tr>
    </tbody>
  </table>
</form>
