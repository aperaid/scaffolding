  ...
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td width="532"><input name="SJKem" type="text" class="textbox" id="SJKem" value="<?php echo str_pad($row_NoSJ['Id']+1, 3, "0", STR_PAD_LEFT); ?>/SI/<?php echo date("mY") ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Tanggal Tertanda</th>
        <th align="right">&nbsp;</th>
      ...
      <tr>
        ...
        <td><a href="SJKembali.php"><button type="button" class="submit">Cancel</button></a></td>
      </tr>
    </tbody>
  </table>
