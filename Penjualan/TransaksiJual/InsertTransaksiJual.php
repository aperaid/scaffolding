...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jualtransaksijual (`No`, Tgl, Customer, JSC, Project, Amount, Status) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <table width="1000" border="0">
    <tbody>
      ...
      <tr>
        ...
        <th align="right">&nbsp;</th>
        <td><input name="JSC" type="text" id="JSC" readonly value="Jual" class="textbox"></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
      ...
      <tr>
        ...
        <td><a href="TransaksiJual.php"><button type="button" class="submit">Cancel</button></a></td>
      </tr>
    </tbody>
  </table>
