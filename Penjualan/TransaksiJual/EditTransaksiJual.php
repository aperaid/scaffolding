...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE jualtransaksijual SET `No`=%s, Tgl=%s, Customer=%s, JSC=%s, Project=%s, Amount=%s, Status=%s WHERE Id=%s",
  ...
  $updateGoTo = "ViewTransaksiJual.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Connection, $Connection);
$query_Edit = sprintf("SELECT * FROM jualtransaksijual WHERE Id = %s", GetSQLValueString($colname_Edit, "int"));
  ...
  <table width="1000" border="0">
    <tbody>
      ...
      <tr>
        ...
        <td><a href="ViewTransaksiJual.php?Id=<?php echo $row_Edit['Id']; ?>"><button type="button" class="submit">Cancel</button></a></td>
      </tr>
    </tbody>
  </table>
