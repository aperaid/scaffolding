...
$colname_Select = "-1";
if (isset($_GET['Reference'])) {
  $colname_Select = $_GET['Reference'];
}
mysql_select_db($database_Connection, $Connection);
$query_Select = sprintf("SELECT SJKir FROM sjkirim WHERE Reference = %s", GetSQLValueString($colname_Select, "text"));
...
mysql_select_db($database_Connection, $Connection);
$query_LastReference = "SELECT Reference FROM sjkirim ORDER BY Reference DESC";
  ...
  <table width="1000" border="0">
	...
	<?php do { ?>
	  <tr>
	    ...
	    <td><input name="IsiSJKir[]" type="text" class="textbox" id="IsiSJKir" value="<?php echo $row_LastIsiSJKirim['Id'] + $increment; ?>"></td>
	    ...
	    <td><input name="Warehouse[]" type="text" class="textbox" id="Warehouse"></td>
	    <td><input name="Quantity[]" type="text" class="textbox" id="Quantity" value="<?php echo $row_InsertSJKirim['Quantity']; ?>" readonly></td>
	    <td><input name="QKirim[]" type="text" class="textbox" id="QKirim" value=0></td>
	    <td><input name="QTertanda[]" type="text" class="textbox" id="QTertanda" value=0></td>
	    <td><input name="Purchase[]" type="text" class="textbox" id="Purchase" value=<?php echo $row_InsertSJKirim['Purchase']; ?>></td>
	    </tr>
	  <?php $increment++; ?>
	...
	<tr>
      ...
      <tr>
		   ...
		   <td><a href="CancelKirim.php?Reference=<?php echo $row_LastReference['Reference']; ?>"><button type="button" class="submit">Cancel</button></a></td>
		   <td>&nbsp;</td>
		   <td>&nbsp;</td>
		   <td>&nbsp;</td>
		   <td>&nbsp;</td>
