...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE jualtransaksisewa SET `No`=%s, TglStart=%s, TglEnd=%s, Customer=%s, JSC=%s, Project=%s, Amount=%s, Status=%s WHERE Id=%s",
...
mysql_select_db($database_Connection, $Connection);
$query_Edit = sprintf("SELECT * FROM jualtransaksisewa WHERE Id = %s", GetSQLValueString($colname_Edit, "int"));
