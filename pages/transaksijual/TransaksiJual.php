...
$query_TransaksiJual = "SELECT pocustomer.Reference, project.Project, customer.Company, project.Project, customer.Customer FROM pocustomer LEFT JOIN project ON pocustomer.PCode=project.PCode LEFT JOIN customer ON project.CCode=customer.CCode ORDER BY pocustomer.Id";
...
<head>
  ...
  <title>BDN ERP | Transaksi Jual</title>
              ...
              <table id="tb_transaksijual_example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="ViewTransaksiJual.php?Reference=<?php echo $row_TransaksiJual['Reference']; ?>"><button type="button" class="btn btn-block btn-primary btn-sm">View</button></a></td>
					</tr>
