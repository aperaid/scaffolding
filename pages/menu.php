<ul class="sidebar-menu">
	...
	<li class="treeview <?php if ($top_menu_sel=="menu_penawaran" || $top_menu_sel=="menu_customer" || $top_menu_sel=="menu_project" || $top_menu_sel=="menu_po" || $top_menu_sel=="menu_sewa" ||  $top_menu_sel=="menu_sjkirim" || $top_menu_sel=="menu_sjkembali" || $top_menu_sel=="menu_invoice") { ?> active <?php } ?>">
		<a href="#">
		...
		<ul class="treeview-menu">
			...
			<li <?php if ($top_menu_sel=="menu_sewa"){ ?> class="active" <?php } ?>><a href="<?php echo $ROOT; ?>pages/transaksisewa/TransaksiSewa.php"><i class="fa fa-money"></i> <span>Transaksi</span></a></li>
