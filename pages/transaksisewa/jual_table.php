<?php
	 ...
	 */
	$aColumns = array( 'Reference', 'Invoice', 'Project' );
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "Reference";
	
	/* DB table to use */
	$sTable = "(SELECT pocustomer.Reference, invoice.Invoice, project.Project
	...
	GROUP BY periode.Reference, periode.Periode) AS t2";
