<?php
	 ...
	 */
	$aColumns = array( 'periodeclaim', 'periodeextend', 'Reference', 'Invoice', 'Periode', 'Tgl', 'Project' );
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "Reference";
	
	/* DB table to use */
	$sTable = "(SELECT periodeclaim, periodeextend, transaksiclaim.*, invoice.Invoice, periode.Reference, transaksi.Barang, transaksi.QSisaKem, project.Project, customer.Customer 
	FROM transaksiclaim 
	...
	ORDER BY transaksiclaim.Id ASC) AS t3";
