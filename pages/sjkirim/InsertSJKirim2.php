...
<body onLoad="submit()">
<form name="fm_insertsjkirim2_form1" id="fm_insertsjkirim2_form1" method="post" action="InsertSJKirimBarang.php?Reference=<?php echo $row_LastReference['Reference']; ?>">
