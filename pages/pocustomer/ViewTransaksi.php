    ...
    <section class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i>SJ Kirim</button>
          <a href="EditTransaksi.php?Reference=<?php echo $row_View['Reference']; ?>" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i>Edit</a>
