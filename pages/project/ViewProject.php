...
<head>
  ...
  <title>BDN ERP | View Project</title>
...
<body onload="check_project_function(<?php echo $row_check['result'] ?>)" class="hold-transition skin-blue fixed sidebar-mini">
<div class="wrapper">
          ...
          <div class="box box-info">
            ...
            <form id="fm_viewproject_form1" name="fm_viewproject_form1" method="post" class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <div class="btn-group" ><a href="DeleteProject.php?PCode=<?php echo $row_View['Id']; ?>" onclick="return confirm('Delete Project?')"><button id="delete_button" type="button" class="btn btn-danger pull-left">Delete</button></a></div>
              </div>
...
<script>
function check_project_function(x) {
if(x == 1){
    //delete button
