...
<script>
function capital() {
    var x = document.getElementById("tx_edittransaksiclaim_No");
    x.value = x.value.toUpperCase();
	var x = document.getElementById("tx_edittransaksiclaim_Customer");
    x.value = x.value.toUpperCase();
	var x = document.getElementById("tx_edittransaksiclaim_Project");
    x.value = x.value.toUpperCase();
}
</script>
