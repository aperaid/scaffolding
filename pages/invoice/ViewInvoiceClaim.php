  ...
  <table id="tb_viewinvoicejual_example1" name="tb_viewinvoicejual_example1" class="table table-bordered table-striped table-responsive">
    ...
    <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input name="tx_viewinvoiceclaim_Totals" type="text" class="form-control" id="tx_viewinvoiceclaim_Totals" value="<?php echo number_format(($total*$row_View['PPN']*0.1)+$total+$row_View['Transport'], 2); ?>" readonly>
