...
<form action="<?php echo $editFormAction; ?>" id="fm_viewinvoicejual_form1" name="fm_viewinvoicejual_form1" method="POST">
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td width="605"><input name="tx_viewinvoicejual_Invoice" type="text" class="textview" id="tx_viewinvoicejual_Invoice" value="<?php echo $row_View['Invoice']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Project</th>
        <th align="right">&nbsp;</th>
        <td><input name="tx_viewinvoicejual_TglStart" type="text" class="textview" id="tx_viewinvoicejual_TglStart" value="<?php echo $row_View['Project']; ?>" readonly></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Company</th>
        <th align="right">&nbsp;</th>
        <td><input name="tx_viewinvoicejual_TglEnd" type="text" class="textview" id="tx_viewinvoicejual_TglEnd" value="<?php echo $row_View['Company']; ?>" readonly></td>
      </tr>
    </tbody>
  </table>
  <table width="1000" border="0">
    <tbody>
	  ...
	  do { ?>
        ...
        <tr>
          <td align="center"><input name="tx_viewinvoicejual_SJKir" type="text" class="textview" id="tx_viewinvoicejual_SJKir" value="<?php echo $row_View2['SJKir']; ?>" readonly></td>
          <td align="center"><input name="tx_viewinvoicejual_Purchase" type="text" class="textview" id="tx_viewinvoicejual_Purchase" value="<?php echo $row_View2['Purchase']; ?>" readonly></td>
          <td align="center"><input name="tx_viewinvoicejual_Barang" type="text" class="textview" id="tx_viewinvoicejual_Barang" value="<?php echo $row_View2['Barang']; ?>" readonly></td>
          <td align="center"><input name="tx_viewinvoicejual_Quantity" type="text" class="textview" id="tx_viewinvoicejual_Quantity" value="<?php echo $row_View2['QKirim']; ?>" readonly></td>
          <td align="center"><input name="tx_viewinvoicejual_Amount" type="text" class="textview" id="tx_viewinvoicejual_Amount" value="<?php echo $row_View2['Amount']; ?>" readonly></td>
          <?php $test = $row_View2['QKirim']* $row_View2['Amount']; $total += $test ?>
          <td align="center"><input name="tx_viewinvoicejual_Total" type="text" class="textview" id="tx_viewinvoicejual_Total" value="<?php echo round($test, 2) ?>" readonly></td>
        </tr>
  ...
  <table width="1000" border="0">
    <tbody>
      <tr>
        ...
        <td colspan="2"><input name="tx_viewinvoicejual_PPN" type="text" class="textbox" id="tx_viewinvoicejual_PPN" autocomplete="off" value="<?php echo $row_View['PPN']; ?>" onKeyUp="ppn()"></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th align="right">Transport</th>
        <th align="right">&nbsp;</th>
        <td colspan="2"><input name="tx_viewinvoicejual_Transport" type="text" class="textbox" id="tx_viewinvoicejual_Transport" autocomplete="off" value="<?php echo $row_View['Transport']; ?>" onKeyUp="transport()"></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        ...
        <td colspan="2"><input name="tx_viewinvoicejual_Totals" type="text" class="textview" id="tx_viewinvoicejual_Totals" value="<?php echo round($total, 2); ?>" readonly></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
      ...
      <tr>
        ...
        <td align="center"><input type="submit" name="bt_viewinvoicejual_submit" id="bt_viewinvoicejual_submit" class="button2" value="Update"></td>
